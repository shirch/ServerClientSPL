...
public class Reactor<T> implements Server<T> {
    ...
    private final ConcurrentLinkedQueue<Runnable> selectorTasks = new ConcurrentLinkedQueue<Runnable>();
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        BidiMessagingProtocol<T> clientMessagingProtocol = protocolFactory.get();
        final NonBlockingConnectionHandler handler = new NonBlockingConnectionHandler(
                readerFactory.get(),
                clientMessagingProtocol,
                clientChan,
                this);
        clientMessagingProtocol.start(((ConnectionsImpl<T>)connections).connect(handler),connections);
